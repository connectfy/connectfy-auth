...
export const signupVerifyMessage = (
  ...
  const subject = i18n.t('email_messages.verify_yourself.subject', { lng: lang });
  const greeting = i18n.t('email_messages.signup_verify.greeting', { lng: lang });
  const thankYou = i18n.t('email_messages.signup_verify.thank_you', { lng: lang });
  const signature = i18n.t('email_messages.signup_verify.signature', { lng: lang });
  const instruction = i18n.t('email_messages.signup_verify.instruction', { lng: lang });
...
export const forgotPasswordMessage = (
  ...
  const support = i18n.t('email_messages.forgot_password.support', { lng: lang });
  const subject = i18n.t('email_messages.forgot_password.subject', { lng: lang });
  const buttonText = i18n.t('email_messages.forgot_password.button', { lng: lang });
  const fallback = i18n.t('email_messages.forgot_password.fallback', { lng: lang });
  const thankYou = i18n.t('email_messages.forgot_password.thank_you', { lng: lang });
...
export const emailNotFoundMessage = (
  ...
  const subject = i18n.t('email_messages.email_not_found.subject', { lng: lang });
  const support = i18n.t('email_messages.email_not_found.support', { lng: lang });
  const buttonText = i18n.t('email_messages.email_not_found.button', { lng: lang });
  const thankYou = i18n.t('email_messages.email_not_found.thank_you', { lng: lang });
  const instruction = i18n.t('email_messages.email_not_found.instruction', { lng: lang });
...
export const googleSignInMessage = (
  ...
  const subject = i18n.t('email_messages.google_sign_in.subject', { lng: lang });
  const support = i18n.t('email_messages.google_sign_in.support', { lng: lang });
  const buttonText = i18n.t('email_messages.google_sign_in.button', { lng: lang });
  const thankYou = i18n.t('email_messages.google_sign_in.thank_you', { lng: lang });
  const instruction = i18n.t('email_messages.google_sign_in.instruction', { lng: lang });
...
export const deleteAccountMessage = (
  ...
  const support = i18n.t('email_messages.delete_account.support', { lng: lang });
  const subject = i18n.t('email_messages.delete_account.subject', { lng: lang });
  const buttonText = i18n.t('email_messages.delete_account.button', { lng: lang });
  const fallback = i18n.t('email_messages.delete_account.fallback', { lng: lang });
  const thankYou = i18n.t('email_messages.delete_account.thank_you', { lng: lang });
...
export const accountDeletedMessage = (
  ...
  const team = i18n.t('email_messages.delete_account_completed.team', { lng: lang });
  const note = i18n.t('email_messages.delete_account_completed.note', { lng: lang });
  const intro = i18n.t('email_messages.delete_account_completed.intro', { lng: lang });
  const support = i18n.t('email_messages.delete_account_completed.support', { lng: lang });
  const subject = i18n.t('email_messages.delete_account_completed.subject', { lng: lang });
  const buttonText = i18n.t('email_messages.delete_account_completed.button', { lng: lang });
  const fallback = i18n.t('email_messages.delete_account_completed.fallback', { lng: lang });
  const signature = i18n.t('email_messages.delete_account_completed.signature', { lng: lang });
  const optionalRestore = i18n.t('email_messages.delete_account_completed.optional_restore', { lng: lang });
...
export const verifyYourselfMessage = (
  ...
  const subject = i18n.t('email_messages.verify_yourself.subject', { lng: lang });
  const support = i18n.t('email_messages.verify_yourself.support', { lng: lang });
  const greeting = i18n.t('email_messages.verify_yourself.greeting', { lng: lang });
  const codeInfo = i18n.t('email_messages.verify_yourself.code_info', { lng: lang });
  const signature = i18n.t('email_messages.verify_yourself.signature', { lng: lang });
  const instruction = i18n.t('email_messages.verify_yourself.instruction', { lng: lang });
